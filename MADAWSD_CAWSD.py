...
class Debate:
    ...
    def init_agents(self):
        ...
        if '答案' in self.aff_ans:
            self.aff_ans = self.aff_ans.replace('答案', 'Answer')
        ...
        if '答案' in self.neg_ans:
            self.neg_ans = self.neg_ans.replace('答案', 'Answer')
...
dataset = ["笔记本", "炒鱿鱼", "出轨", "发烧", "放鸽子", "火箭", "火星", "加油", "骄傲", "联想",
        "满月", "上火", "生气", "算账", "台风", "铁饭碗", "下海", "下课", "小米", "眼线"]
sense = [("电脑", "纸质本子"), ("开除", "食物"), ("背叛", "脱轨"), ("热爱", "疾病"), ("爽约", "放飞鸽子"), ("篮球队", "飞行器"), 
         ("行星", "极小的火"), ("鼓励", "加入油类"), ("傲慢", "自豪"), ("公司", "想象"), ("月亮", "满一个月"),  ("愤怒", "疾病"), 
         ("生命力", "愤怒"), ("追究责任", "计算账目"), ("舞台风格", "天气"), ("工作", "餐具"), ("经商", "下到海里"), ("开除", "课后休息"), ("食物", "公司"), 
         ("间谍", "化妆术语")]
...
for idx in tqdm(range(len(dataset)), desc="Waiting-debate"):
    ...
    now_f1 = f1_score(labels, results)
